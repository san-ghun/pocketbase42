import{S as We,i as Xe,s as Ye,e,b as s,E as tl,f as i,g as u,u as Ze,y as Ie,o as m,w,h as t,M as ke,c as Zt,m as te,x as ge,N as Be,O as el,k as ll,P as sl,n as nl,t as Bt,a as Gt,d as ee,Q as ol,T as il,C as $e,p as al,r as ye}from"./index-3fa838ae.js";import{S as rl}from"./SdkTabs-59d56bac.js";function cl(c){let n,o,a;return{c(){n=e("span"),n.textContent="Show details",o=s(),a=e("i"),i(n,"class","txt"),i(a,"class","ri-arrow-down-s-line")},m(p,b){u(p,n,b),u(p,o,b),u(p,a,b)},d(p){p&&m(n),p&&m(o),p&&m(a)}}}function dl(c){let n,o,a;return{c(){n=e("span"),n.textContent="Hide details",o=s(),a=e("i"),i(n,"class","txt"),i(a,"class","ri-arrow-up-s-line")},m(p,b){u(p,n,b),u(p,o,b),u(p,a,b)},d(p){p&&m(n),p&&m(o),p&&m(a)}}}function Ge(c){let n,o,a,p,b,d,h,g,x,_,f,Z,Ct,Ut,R,jt,H,at,P,tt,le,U,j,se,rt,$t,et,kt,ne,ct,dt,lt,E,Jt,yt,L,st,vt,Qt,Ft,J,nt,Lt,zt,At,T,ft,Tt,oe,pt,ie,D,Ot,ot,Pt,S,ut,ae,Q,St,Kt,Rt,re,N,Vt,z,mt,ce,I,de,B,fe,O,Et,K,bt,pe,ht,ue,$,Nt,it,qt,me,Mt,Wt,V,_t,be,Ht,he,xt,_e,W,wt,Xt,X,Yt,q,gt,y,Dt,xe,Y,A,It,G,v;return{c(){n=e("p"),n.innerHTML=`The syntax basically follows the format
        <code><span class="txt-success">OPERAND</span> 
            ...
            `),x=e("br"),_=s(),f=e("ul"),Z=e("li"),Ct=e("code"),Ct.textContent="=",Ut=s(),R=e("span"),R.textContent="Equal",jt=s(),H=e("li"),at=e("code"),at.textContent="!=",P=s(),tt=e("span"),tt.textContent="NOT equal",le=s(),U=e("li"),j=e("code"),j.textContent=">",se=s(),rt=e("span"),rt.textContent="Greater than",$t=s(),et=e("li"),kt=e("code"),kt.textContent=">=",ne=s(),ct=e("span"),ct.textContent="Greater than or equal",dt=s(),lt=e("li"),E=e("code"),E.textContent="<",Jt=s(),yt=e("span"),yt.textContent="Less than",L=s(),st=e("li"),vt=e("code"),vt.textContent="<=",Qt=s(),Ft=e("span"),Ft.textContent="Less than or equal",J=s(),nt=e("li"),Lt=e("code"),Lt.textContent="~",zt=s(),At=e("span"),At.textContent=`Like/Contains (if not specified auto wraps the right string OPERAND in a "%" for
    ...
    `,dart:`
        ...
        // you can also fetch all records at once via getFullList
        final records = await pb.collection('${(Pe=c[0])==null?void 0:Pe.name}').getFullList(
          sort: '-created',
        );
    ...
    `}});let v=c[1]&&Qe();ot=new ke({props:{content:`
            ...
            <td>Specify the max returned records per page (default to 30).</td>`,Ft=s(),J=e("tr"),nt=e("td"),nt.textContent="sort",Lt=s(),zt=e("td"),zt.innerHTML='<span class="label">String</span>',At=s(),T=e("td"),ft=w("Specify the records order attribute(s). "),Tt=e("br"),oe=w(`
                Add `),pt=e("code"),pt.textContent="-",ie=w(" / "),D=e("code"),D.textContent="+",Ot=w(` (default) in front of the attribute for DESC / ASC order.
                Ex.:
                `),Zt(ot.$$.fragment),Pt=s(),S=e("p"),ut=e("strong"),ut.textContent="Supported record sort fields:",ae=s(),Q=e("br"),St=s(),Kt=e("code"),Kt.textContent="@random",Rt=w(`,
                ...
                `),Zt(B.$$.fragment),fe=s(),Zt(O.$$.fragment),Et=s(),K=e("tr"),bt=e("td"),bt.textContent="expand",pe=s(),ht=e("td"),ht.innerHTML='<span class="label">String</span>',ue=s(),$=e("td"),Nt=w(`Auto expand record relations. Ex.:
                `),Zt(it.$$.fragment),qt=w(`
            ...
            <td>Comma separated string of the fields to return in the JSON response
                <em>(by default returns all fields)</em>.</td>`,Xt=s(),X=e("div"),X.textContent="Responses",Yt=s(),q=e("div"),gt=e("div");for(let l=0;l<y.length;l+=1)y[l].c();xe=s(),Y=e("div");for(let l=0;l<A.length;l+=1)A[l].c();i(n,"class","m-b-sm"),i(h,"class","content txt-lg m-b-sm"),i(H,"class","m-b-xs"),i(tt,"class","label label-primary"),i(U,"class","content"),i(P,"class","alert alert-info"),i(dt,"class","section-title"),i(E,"class","table-compact table-border m-b-base"),i(X,"class","section-title"),i(gt,"class","tabs-header compact left"),i(Y,"class","tabs-content"),i(q,"class","tabs")},m(l,r){u(l,n,r),t(n,o),t(n,p),t(n,b),u(l,d,r),u(l,h,r),t(h,g),t(g,x),t(g,_),t(_,Z),t(g,Ct),u(l,Ut,r),te(R,l,r),u(l,jt,r),u(l,H,r),u(l,at,r),u(l,P,r),t(P,tt),t(P,le),t(P,U),t(U,j),t(j,se),t(j,rt),t(rt,et),t(j,kt),t(P,ne),v&&v.m(P,null),u(l,ct,r),u(l,dt,r),u(l,lt,r),u(l,E,r),t(E,Jt),t(E,yt),t(E,L),t(L,st),t(L,vt),t(L,Qt),t(L,Ft),t(L,J),t(J,nt),t(J,Lt),t(J,zt),t(J,At),t(J,T),t(T,ft),t(T,Tt),t(T,oe),t(T,pt),t(T,ie),t(T,D),t(T,Ot),te(ot,T,null),t(T,Pt),t(T,S),t(S,ut),t(S,ae),t(S,Q),t(S,St),t(S,Kt),t(S,Rt);for(let C=0;C<k.length;C+=1)k[C]&&k[C].m(S,null);t(L,re),t(L,N),t(N,Vt),t(N,z),t(N,mt),t(N,ce),t(N,I),t(I,de),te(B,I,null),t(I,fe),te(O,I,null),t(L,Et),t(L,K),t(K,bt),t(K,pe),t(K,ht),t(K,ue),t(K,$),t($,Nt),te(it,$,null),t($,qt),t($,me),t($,Mt),t($,Wt),t($,V),t($,_t),t($,be),t($,Ht),t($,he),t($,xt),t($,_e),t(L,W),t(L,wt),u(l,Xt,r),u(l,X,r),u(l,Yt,r),u(l,q,r),t(q,gt);for(let C=0;C<y.length;C+=1)y[C]&&y[C].m(gt,null);t(q,xe),t(q,Y);for(let C=0;C<A.length;C+=1)A[C]&&A[C].m(Y,null);G=!0},p(l,[r]){var Re,Ee,Ne,qe,Me,He;(!G||r&1)&&a!==(a=l[0].name+"")&&ge(p,a),(!G||r&1)&&f!==(f=l[0].name+"")&&ge(Z,f);const C={};if(r&9&&(C.js=`
        import PocketBase from 'pocketbase';
    ...
    `),R.$set(C),(!G||r&1)&&$t!==($t=l[0].name+"")&&ge(et,$t),l[1]?v||(v=Qe(),v.c(),v.m(P,null)):v&&(v.d(1),v=null),r&16){F=l[4];let M;for(M=0;M<F.length;M+=1){const De=Je(l,F,M);k[M]?k[M].p(De,r):(k[M]=ze(De),k[M].c(),k[M].m(S,null))}for(;M<k.length;M+=1)k[M].d(1);k.length=F.length}r&36&&(Ce=l[5],y=Be(y,r,ve,1,l,Ce,Dt,gt,el,Ke,null,je)),r&36&&(we=l[5],ll(),A=Be(A,r,Fe,1,l,we,It,Y,sl,Ve,null,Ue),nl())},i(l){if(!G){Bt(R.$$.fragment,l),Bt(ot.$$.fragment,l),Bt(B.$$.fragment,l),Bt(O.$$.fragment,l),Bt(it.$$.fragment,l);for(let r=0;r<we.length;r+=1)Bt(A[r]);G=!0}},o(l){Gt(R.$$.fragment,l),Gt(ot.$$.fragment,l),Gt(B.$$.fragment,l),Gt(O.$$.fragment,l),Gt(it.$$.fragment,l);for(let r=0;r<A.length;r+=1)Gt(A[r]);G=!1},d(l){l&&m(n),l&&m(d),l&&m(h),l&&m(Ut),ee(R,l),l&&m(jt),l&&m(H),l&&m(at),l&&m(P),v&&v.d(),l&&m(ct),l&&m(dt),l&&m(lt),l&&m(E),ee(ot),ol(k,l),ee(B),ee(O),ee(it),l&&m(Xt),l&&m(X),l&&m(Yt),l&&m(q);for(let r=0;r<y.length;r+=1)y[r].d();for(let r=0;r<A.length;r+=1)A[r].d()}}}function bl(c,n,o){let a,p,b,{collection:d=new il}=n,h=200,g=[];const x=_=>o(2,h=_.code);return c.$$set=_=>{"collection"in _&&o(0,d=_.collection)},c.$$.update=()=>{c.$$.dirty&1&&o(4,a=$e.getAllCollectionIdentifiers(d)),c.$$.dirty&1&&o(1,p=(d==null?void 0:d.listRule)===null),c.$$.dirty&3&&d!=null&&d.id&&(g.push({code:200,body:JSON.stringify({page:1,perPage:30,totalPages:1,totalItems:2,items:[$e.dummyCollectionRecord(d),$e.dummyCollectionRecord(d)]},null,2)}),g.push({code:400,body:`
                {
                  "code": 400,
